...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id7.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id8.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id9.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id10.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id11.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id12.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id13.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id14.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id15.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id16.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id17.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id18.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id19.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id20.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id21.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id22.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id23.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
...
<?php 
$data = file_get_contents('https://itunes.apple.com/lookup?id='.$featbook_id24.'&entity=ebook&country='.$site_country.'');
$response = json_decode($data);
