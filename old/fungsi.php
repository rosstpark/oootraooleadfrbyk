...
$patern= 'duckduckgo|bot|google|bing|yahoo|msn|image|preview|partner|bingpreview|bingbot|msnbot|woobot|internetVista|openlinkprofiler|spbot|acunetix|fhscan|trendictionbot';
...
$posisi_cache= $second_folder.'/'.md5($keyword).'.cache';
	...
	$header[] = "Pragma: "; // browsers keep this blank.
	 ...
	 curl_setopt($data, CURLOPT_REFERER, 'https://twitter.com/');
